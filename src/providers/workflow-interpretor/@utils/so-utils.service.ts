...
import { WorkflowInstanceContextDto, SmartObjectDto, SysFile, DocumentDto, SmartModelDto, PairDto, ImportOptionsDto } from '@algotech/core';
import { Injectable } from '@nestjs/common';
import { SoUtils } from '@algotech/interpretor';
